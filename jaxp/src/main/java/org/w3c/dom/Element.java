...
public interface Element extends Node {
     ...
     * @return The <code>Attr</code> value as a string, or the empty string
     * if that attribute does not have a specified or default value.
     * @throws DOMException NOT_SUPPORTED_ERR: May be raised if the implementation does not
     ...
     * @throws DOMException INVALID_CHARACTER_ERR: Raised if the specified qualified name is not
