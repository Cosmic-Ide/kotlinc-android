...
public abstract class Validator {
     ...
     * @throws IllegalArgumentException If the {@code Source}
     ...
     *               Implementations must either recognize and process the input
     *               or throw an IllegalArgumentException.
     * @param result The {@code Result} object that receives (possibly augmented)
     ...
     * @throws IllegalArgumentException If the {@code Result} type doesn't match the
     *                                  {@code Source} type or if the {@code Source}
     *                                  is an XML artifact that the implementation cannot
     *                                  validate (for example, a processing instruction).
     * @throws SAXException             If the {@code ErrorHandler} throws a
