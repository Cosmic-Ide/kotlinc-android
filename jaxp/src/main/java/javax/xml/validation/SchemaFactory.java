...
public abstract class SchemaFactory {
     ...
     * @return New instance of a {@code SchemaFactory}
     * @throws IllegalArgumentException if {@code factoryClassName} is {@code null}, or
     ...
     *
     * @param schemas inputs to be parsed. {@link SchemaFactory} is required
     ...
     * @return Always return a non-null valid {@link Schema} object.
     * Note that when an error has been reported, there is no
     * guarantee that the returned {@link Schema} object is
     * meaningful.
     * @throws SAXException                  If an error is found during processing the specified inputs.
     *                                       When an {@link ErrorHandler} is set, errors are reported to
     *                                       there first. See {@link #setErrorHandler(ErrorHandler)}.
     * @throws NullPointerException          If the {@code schemas} parameter itself is null or
